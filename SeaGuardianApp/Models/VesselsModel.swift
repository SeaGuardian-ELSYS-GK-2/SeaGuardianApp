...
extension VesselsModel {
    static var preview: VesselsModel {
        ...
        model.vessels["1"] = Vessel(
            ...
            longitude: 10.3951,
            crew: [
                "1_1": CrewMember(id: "1_1", name: "Alice", overBoard: false, latitude: nil, longitude: nil),
                "1_2": CrewMember(id: "1_2", name: "Bob", overBoard: true, latitude: 63.4675, longitude: 10.4192)
            ]
        )
        ...
        model.vessels["3"] = Vessel(
            ...
            longitude: 9.820900,
            crew: [
                "3_1": CrewMember(id: "3_1", name: "James", overBoard: false, latitude: nil, longitude: nil)
            ]
        )
